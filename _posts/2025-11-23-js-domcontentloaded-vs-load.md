...
cover: /assets/images/posts/js-dom-loaded-cover.png
---
...
<head>
    ...
    <style>
        ...
        .demo-image {
            ...
            height: auto;
            margin: 20px 0;
            /* 故意设置较大图片（模拟加载延迟），便于观察事件触发顺序 */
            content: url("/assets/images/posts/large-demo-image.jpg");
        }
    </style>
</head>
<body>
    <div class="demo-container">
        ...
        <!-- 模拟大图片，制造加载延迟 -->
        <div class="demo-image" alt="演示图片"></div>
    </div>
